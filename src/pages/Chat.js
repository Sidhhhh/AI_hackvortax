  ...
  return (
    ...
    <div className="container">
      ...
      <ul className="suggestions">
        ...
        <li className="suggestions-item">
          <p className="text">How can I level up my web development expertise in 2025?</p>
          <span className="icon material-symbols-rounded">lightbulb</span>
        </li>
        <li className="suggestions-item">
          <p className="text">Suggest some useful tools for debugging JavaScript code.</p>
          <span className="icon material-symbols-rounded">explore</span>
        </li>
        <li className="suggestions-item">
          <p className="text">Create a React JS component for the simple todo list app.</p>
          <span className="icon material-symbols-rounded">code_blocks</span>
        </li>
      </ul>
      ...
      <div className="prompt-container">
        <div className="prompt-wrapper">
          <form action="#" className="prompt-form">
            <input type="text" placeholder="Ask Anything..." className="prompt-input" required />
            <div className="prompt-actions">
              <div className="file-upload-wrapper">
                ...
                <button id="cancel-file-btn" type="button" className="material-symbols-rounded">close</button>
                <button id="add-file-btn" type="button" className="material-symbols-rounded">attach_file</button>
              </div>

              <button id="stop-response-btn" type="button" className="material-symbols-rounded">stop_circle</button>
              <button id="send-prompt-btn" className="material-symbols-rounded">arrow_upward</button>
            </div>
          </form>
          <button id="theme-toggle-btn" className="material-symbols-rounded">light_mode</button>
          <button id="delete-chats-btn" className="material-symbols-rounded">delete</button>
        </div>
      </div>
    </div>
    <style>
