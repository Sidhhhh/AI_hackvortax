...
const Card = () => {
  return (
    <StyledWrapper>
      <div className="cards">
        <div className="card-container twitter-card">
          <div className="icon-container">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 50 50" fill="#fff">
        ...
        <div className="card-container facebook-card">
          <div className="icon-container">
        ...
        <div className="card-container instagram-card">
          <div className="icon-container">
